...
/**
 * This sample creates a jvmstat counter and increments it everytime Thread.start() is called. This thread count may be accessed from outside the
 * process. The @Export annotated fields are mapped to jvmstat counters. The counter name is "btrace." + <className> + "." + <fieldName>
 */
@BTrace
