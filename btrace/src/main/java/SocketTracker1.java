...
/**
 * This example tracks all server socket creations and client socket accepts. Unlike SockerTracker.java, this script uses only public API classes and
 *
 * @OnProbe probes - which would be mapped to internal implementation classes by a XML descriptor at BTrace agent. For this sample, XML probe
 * descriptor is "java.net.socket.xml".
 */
@BTrace
