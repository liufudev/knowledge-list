...
/**
 * This script demonstrates the possibility to intercept method calls that are about to be executed from the body of a certain method. This is
 * achieved by using the {@linkplain Kind#CALL} location value.
 */
@BTrace
