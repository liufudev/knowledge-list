...
/**
 * This script demonstrates the possibility to intercept array creations that are about to be executed from the body of a certain method. This is
 * achieved by using the {@linkplain Kind#NEWARRAY} location value.
 */
@BTrace
